...
function AboutsUs() {
    ...
    return (
        <>
            ...
            <div className=" flex-row lg:flex flex-wrap justify-center item-center xl:pl-[15%] xl:pr-[15%] p-8">
            ...
            <div className='opacity-90 p-5 lg:p-20 bg-[#001e57] flex flex-col lg:flex-row lg:pl-[20%] lg:pr-[20%]'>
                <div className='p-10 lg:p-14  w-[100%] bg-white lg:-mt-5'>
                    ...
                    <hr className='border-t-1 p-0 border-gray-600 w-20 mx-auto mt-4' />
