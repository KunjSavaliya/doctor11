...
function Contact() {
    ...
    return (
        <div>
            {/* Banner Section */}
            <div className="relative w-full h-[250px] sm:h-[300px] md:h-[400px] -mt-2">
                <img src={doctor} alt="carousel" className="w-full h-full object-cover" />
                <div className="flex flex-col gap-4 sm:gap-6 absolute top-0 left-0 p-3 sm:p-5 text-white h-full justify-center items-start sm:pl-12 lg:pl-36">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">Contact us</h2>
                    <div className="flex gap-2 text-base sm:text-lg md:text-xl">
            ...
            <div className="px-4 sm:px-5 md:px-[10%] xl:px-[20%] mt-8 md:mt-10">
                <div className="flex flex-col lg:flex-row gap-6 sm:gap-10">
                    {/* Contact Details */}
                    <div className="bg-[#14B0EB] p-6 sm:p-8 md:p-10 w-full lg:w-1/2 animate__animated animate__fadeInLeft">
                        <div>
                            <p className="text-white font-bold text-xl sm:text-2xl md:text-3xl">Contact Details</p>
                            ...
                            <div className="flex gap-3 mt-6 items-start">
                                <CiLocationOn className="text-[#fffc] text-2xl sm:text-3xl md:text-4xl" />
                                <p className="text-[#fffc]">Rosevill sky Opp Croma, Nr. Shukan cross road, Nikol - Naroda Rd, Ahmedabad, Gujarat 382346</p>
                            </div>
                            
                            <div className="flex gap-3 mt-6 items-start">
                                <HiOutlineMailOpen className="text-[#fffc] text-2xl sm:text-3xl md:text-4xl" />
                                <div>
                            ...
                            <div className="flex gap-3 mt-6 items-start">
                                <MdAddIcCall className="text-[#fffc] text-2xl sm:text-3xl md:text-4xl" />
                                <div>
                    ...
                    {/* Google Map */}
                    <div className="w-full lg:w-1/2 h-[250px] sm:h-[300px] md:h-[450px] animate__animated animate__fadeInRight">
                        <iframe
