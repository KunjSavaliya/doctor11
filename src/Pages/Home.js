        ...
        <>
            <div className="relative w-full h-[400px] -mt-2 ">
                ...
                <div className=" flex flex-col gap-10 absolute top-0 left-0 p-5 text-white">
                    <h2 className="text-5xl w-[70%] font-bold pl-36 animate__animated animate__fadeInDown">{textContent[currentImage]}</h2>
                    <div className='pl-36'>
            ...
            <div className="flex flex-wrap "> {/* Main div with 50% width */}
                ...
                <div className="flex-1  w-[50%] bg-[#f3f5f9] p-8 pl-32 pr-32">
            ...
            <div className='bg-[#001e57] '>
                ...
                <div className='pl-36 pr-36 flex flex-wrap justify-around gap-6'>
                    {/* First Card */}
                    <div className='flex flex-col items-center'>
                        ...
                        <p className='text-[#14B0EB] w-80 text-center mt-5'>At Plexus Heart Surgery Centre, we understand the profound impact heart health concerns can have on your life......</p>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <p className='text-[#14B0EB] w-80 text-center mt-5'>At Plexus Heart Surgery Centre, we understand the critical role healthy heart valves play in maintaining a well-functioning cardiovascular system.....</p>
                        <p className='text-[#14B0EB]'>Read more</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <div className='bg-white border  animate__animated animate__pulse border-black p-2'> {/* Added p-2 for padding */}
                        ...
                        <p className='text-[#14B0EB] w-80 text-center mt-5'>Traditionally, coronary artery bypass grafting (CABG) has involved open-heart surgery with a large incision through the chest.....</p>
                        <p className='text-[#14B0EB]'>Read more</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <div className='bg-white border  animate__animated animate__pulse border-black p-2'> {/* Added p-2 for padding */}
                        ...
                        <p className='text-[#14B0EB] w-80 text-center mt-5'>The mitral valve plays a vital role in ensuring smooth blood flow within the heart. When this valve malfunctions, it can significantly impact your heart's ability to pump blood efficiently....</p>
                        <p className='text-[#14B0EB]'>Read more</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <div className='bg-white border  animate__animated animate__pulse border-black p-2'> {/* Added p-2 for padding */}
                        ...
                        <p className='text-[#14B0EB] w-80 text-center mt-5'>Plexus Heart Surgery Centre is a leading cardiac care provider in Ahmedabad. It offers comprehensive treatment options for coronary artery disease, including coronary artery bypass surgery (CABG).....</p>
                        <p className='text-[#14B0EB]'>Read more</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <div className='bg-white border  animate__animated animate__pulse border-black p-2'> {/* Added p-2 for padding */}
                        ...
                        <p className='text-[#14B0EB] w-80 text-center mt-5'>The left ventricle, your heart's main pumping chamber, can become weakened and bulge outward due to a condition called left ventricular aneurysm (LVA).....</p>
                        <p className='text-[#14B0EB]'>Read more</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <div className='bg-white border  animate__animated animate__pulse border-black p-2'> {/* Added p-2 for padding */}
                        ...
                        <p className='text-[#14B0EB] w-80 text-center mt-5'>The aortic root, the very foundation of your aorta, plays a critical role in directing blood flow from your heart to the rest of your body.....</p>
                        <p className='text-[#14B0EB]'>Read more</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <div className='bg-white border  animate__animated animate__pulse border-black p-2'> {/* Added p-2 for padding */}
                        ...
                        <p className='text-[#14B0EB] w-80 text-center mt-5'>While bypass surgery has become a mainstay for treating blocked coronary arteries, there's another option for certain patients: coronary endarterectomy.....
                            Read more </p>
                        <p className='text-[#14B0EB]'>Read more</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        ...
                        <p className='text-[#14B0EB] w-80 text-center mt-5'>While most heart conditions involve blockages or weakened muscles, myxomas present a unique challenge. These rare, non-cancerous tumors arise from the heart's connective tissue and can disrupt blood flow within the chambers....</p>
                        <p className='text-[#14B0EB]'>Read more</p>
                    </div>
